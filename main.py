...
pygame.display.set_caption('我爱高圆圆')
background = pygame.image.load('images/img_bg_level_5.jpg').convert()
...
def main():
    ...
    life_image = pygame.image.load('images/life22.png').convert_alpha()
        ...
        if life_num and not paused:
            ...
            if  not(delay % 10) and not flozen:
                ...
                if is_double_bullet:
                    ...
                    bullets[bullet2_index + 1].reset((me.rect + 33,me.rect.centery))
